# Puzzles & Chaos: Frozen Castle — Strategy Playbook

Welcome to the **Puzzles & Chaos: Frozen Castle** master strategy playbook. This repository contains battle-tested operational guides, tactical manuals, and progression blueprints designed for alliance leadership and competitive players.

---

## 📚 Playbook Modules & Roadmap

| Module | Category | Description | Status |
| :--- | :--- | :--- | :--- |
| [**Interactive Web Playbook (HTML)**](file:///c:/Users/magus/Documents/gemini_projects/puzzles_chaos/index.html) | Web Application | Full interactive dashboard with live calculators, search bar, copy tools, and mobile-friendly tabs. | **Live (v1.0)** |
| [**Conquest of Lords**](file:///c:/Users/magus/Documents/gemini_projects/puzzles_chaos/events/conquest_of_lords.md) | Realm Warfare (SvS) | Complete operational manual for the bi-weekly Hall of Might & Cross-Realm war (Schedule, Spires, 12k Scoring, Diplomacy & Coalition). | **Complete** |
| **Ace Lord** | Individual & Alliance Event | Point optimization, stage-by-stage calendar, and resource hoarding strategy. | *Upcoming* |
